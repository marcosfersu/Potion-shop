...
export default class Controls {
  constructor() {
    ...
    this.circleFirst = this.experience.word.floor.circleFirst;
    this.circleSecond = this.experience.word.floor.circleSecond;
    this.circleThird = this.experience.word.floor.circleThird;
