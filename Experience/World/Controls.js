  ...
  setScrollTrigger() {
    ScrollTrigger.matchMedia({
      ...
      "(min-width: 2200px)": () => {
        ...
        this.rectLight[1].height = 0.5;
        this.rectLight[2].width = 0.5;
        this.rectLight[2].height = 0.5;
      ...
      "(max-width: 968px)": () => {
        ...
        this.rectLight[1].height = 0.3;
        this.rectLight[2].width = 0.3;
        this.rectLight[2].height = 0.3;
